...
namespace test3
{
    public partial class App : Application
    {
        ...
        {
            Debug.WriteLine(String.Format("{0}-Activated被触发", DateTime.Now.ToLongTimeString()));
            ...
            {
                Debug.WriteLine(String.Format("{0}-从逻辑删除中恢复", DateTime.Now.ToLongTimeString()));
                appData = PhoneApplicationService.Current.State["data"] as String;
            }
        }
        ...
        {
            Debug.WriteLine(String.Format("{0}-Deactivated被触发", DateTime.Now.ToLongTimeString()));
        ...
        {
            Debug.WriteLine(String.Format("{0}-Closing被触发", DateTime.Now.ToLongTimeString()));
        }
